...
#define ERR_BSAFE_INVALID_XCERT				(PKG_BSAFE+38)
	errortext(ERR_BSAFE_INVALID_XCERT,		"An invalid Cross Certificate was found for subject: %a. The public keys do not match. The cause of this is either a corrupted Cross Certificate or an attack. Please notify your administrator")	
...
#define ERR_BSAFE_INVALID_XCERT_NO_ARG		(PKG_BSAFE+70)
	errortext(ERR_BSAFE_INVALID_XCERT_NO_ARG,	"An invalid Cross Certificate was found. The public keys do not match. The cause of this is either a corrupted Cross Certificate or an attack. Please notify your administrator")	
